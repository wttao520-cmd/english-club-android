...
GROUPS = [
    ...
    # ------------------------------------------------------------ 辅音二合字母
    {
        ...
        "entries": [
            ...
            {"g": "ng", "ipa": "/ŋ/", "note": "后鼻音，sing / king",
             "words": [("sing", "s|i|ng", "唱歌"), ("king", "k|i|ng", "国王"), ("long", "l|o|ng", "长的")]},
            {"g": "nk", "ipa": "/ŋk/", "note": "ng + k，thank / drink",
...
# ---------------------------------------------------------------- 词族短句
FAMILY_SENTENCES = [
    {"g": "-at", "ipa": "/æt/", "note": "cat / sat / mat / hat 同韵",
